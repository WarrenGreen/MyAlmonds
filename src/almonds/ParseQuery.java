...
public class ParseQuery
{
	private String mClassName; // the name of the Parse class to perform the
								// query on
	private Map<String, Object> mWhereEqualTo = new HashMap<String, Object>(); // tracks "WHERE" constraints
	...
	private String getJSONWhereConstraints()
	{
		...
		if (!mWhereEqualTo.isEmpty())
		{
			JSONObject jo = new JSONObject();

			try
			{
				for(Entry<String, Object> e: mWhereEqualTo.entrySet()) {
